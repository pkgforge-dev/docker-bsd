...
⭐ This is the model this repository uses: the work here is a backlog of
independent tools and fixes, re-orderable, with no dependency chain to number.
[`authoring.md`](authoring.md) says how an entry is written.
